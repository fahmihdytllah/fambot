...
* Prefix bot multi
* Author Fahmi cog
* Rest Api (fahmiapi.herokuapp.com and api.fahmicog.site)
*/
const prefix = '.'
...
Untuk biaya sewa bot perbulan adalah sekitar : *25K/GRUP (BULAN)*.
...
Bot ini merupakan open-source bot dengan nama asli FamBot yang tersedia di GitHub secara gratis.
Owner/hoster dari bot ini terlepas dari tanggung jawab dan pengawasan developer (Fahmi).
